...
__global__ void copy(float *odata, float *idata, int width, int height, int gridDimX, int gridDimY, int init_BlkIdx)
{
...
__global__ void copySharedMem(float *odata, float *idata, int width, int height, int gridDimX, int gridDimY, int init_BlkIdx)
{
...
__global__ void transposeNaive(float *odata, float *idata, int width, int height, int gridDimX, int gridDimY, int init_BlkIdx)
{
    int blk_index = blockIdx.x + init_BlkIdx;
    int bx = blk_index % gridDimX; // This is necessary because of the grid linearization
    int by = blk_index / gridDimX;
...
__global__ void transposeCoalesced(float *odata, float *idata, int width, int height, int gridDimX, int gridDimY, int init_BlkIdx)
{
    // Handle to thread block group
    cg::thread_block cta = cg::this_thread_block();
    __shared__ float tile[TILE_DIM][TILE_DIM];
...
__global__ void transposeNoBankConflicts(float *odata, float *idata, int width, int height, int gridDimX, int gridDimY, int init_BlkIdx)
{
    // Handle to thread block group
    cg::thread_block cta = cg::this_thread_block();
...
__global__ void transposeDiagonal(float *odata, float *idata, int width, int height, int gridDimX, int gridDimY, int init_BlkIdx)
{
    // Handle to thread block group
    cg::thread_block cta = cg::this_thread_block();
    __shared__ float tile[TILE_DIM][TILE_DIM+1];
...
__global__ void transposeFineGrained(float *odata, float *idata, int width, int height, int gridDimX, int gridDimY, int init_BlkIdx)
{
    // Handle to thread block group
    cg::thread_block cta = cg::this_thread_block();
...
__global__ void transposeCoarseGrained(float *odata, float *idata, int width, int height, int gridDimX, int gridDimY, int init_BlkIdx)
{
    // Handle to thread block group
    cg::thread_block cta = cg::this_thread_block();
    __shared__ float block[TILE_DIM][TILE_DIM+1];
